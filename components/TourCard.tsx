      ...
      >
        <div className="relative h-72 overflow-hidden">
          ...
          <div className="absolute top-6 left-6 flex flex-wrap gap-2 max-w-[80%]">
            <div className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-md text-[10px] font-bold uppercase tracking-widest shadow-sm text-jvto-navy">
              {tour.origin}
            </div>
        ...
        <div className="p-10 flex-grow flex flex-col">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2 text-jvto-gold">
              ...
              <span className="text-[10px] font-bold text-jvto-navy uppercase tracking-widest">{tour.rating} Rating</span>
            </div>
          ...
          <Link href={`/tours/${tour.slug}`}>
            <h3 className="text-3xl font-display font-bold mb-4 group-hover:text-jvto-orange transition-colors cursor-pointer leading-tight text-jvto-navy">{tour.name}</h3>
          </Link>
          
          <div className="mt-auto">
            <div className="flex items-center justify-between pt-8 border-t border-jvto-border mb-8">
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-bold uppercase tracking-widest text-jvto-muted">Duration</span>
                <span className="text-sm font-light text-jvto-navy flex items-center gap-2"><Calendar size={14} /> {tour.duration}</span>
              </div>
              <div className="text-right">
                <span className="text-[10px] font-bold uppercase tracking-widest text-jvto-muted block mb-1">From</span>
