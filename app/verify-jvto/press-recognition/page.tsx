          ...
          <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-stone-50 rounded-2xl border border-stone-100">
                ...
                <a href={SITE_CONFIG.reputation.tripadvisor} target="_blank" className="text-xs font-bold text-brand-olive hover:text-orange-500 transition-colors flex items-center gap-1">
              ...
              <div className="p-6 bg-stone-50 rounded-2xl border border-stone-100">
                ...
                <a href={SITE_CONFIG.reputation.trustpilot} target="_blank" className="text-xs font-bold text-brand-olive hover:text-orange-500 transition-colors flex items-center gap-1">
                  View Profile <ExternalLink size={12} />
                </a>
              </div>
              ...
              <div className="p-6 bg-stone-50 rounded-2xl border border-stone-100">
                ...
                <a href={SITE_CONFIG.reputation.googleMaps} target="_blank" className="text-xs font-bold text-brand-olive hover:text-orange-500 transition-colors flex items-center gap-1">
