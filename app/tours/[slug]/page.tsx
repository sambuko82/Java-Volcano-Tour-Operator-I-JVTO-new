            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32 space-y-12">
                <div className="bg-white p-16 rounded-[64px] shadow-2xl shadow-brand-olive/10 border border-stone-50">
                  <div className="text-[10px] font-bold text-stone-400 uppercase tracking-[0.3em] mb-6 ml-2">Starting From</div>
                  <div className="text-6xl font-serif text-brand-olive mb-12 leading-none">{formatPrice(tour.priceFrom)}</div>
                  
                  <div className="space-y-8 mb-16">
                    <div className="flex items-center gap-5 text-stone-600">
                      <div className="w-12 h-12 rounded-2xl bg-brand-cream flex items-center justify-center text-brand-olive shadow-sm">
                        <Users size={24} />
                      </div>
                    ...
                    <div className="flex items-center gap-5 text-stone-600">
                      ...
                      <span className="text-lg font-light tracking-wide">Instant Confirmation</span>
                    </div>
                  </div>

                  <button 
                    onClick={() => setIsFormOpen(true)}
                    className="w-full bg-brand-olive text-white py-8 rounded-full font-bold text-xs uppercase tracking-[0.2em] hover:bg-brand-ink transition-all flex items-center justify-center gap-4 shadow-xl shadow-brand-olive/20 group"
                  >
