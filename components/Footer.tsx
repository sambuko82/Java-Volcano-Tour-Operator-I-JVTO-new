    ...
    <footer className="bg-brand-ink text-white pt-32 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] mb-10 text-white/60">Quick Links</h4>
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] mb-10 text-white/60">Contact</h4>
            <ul className="space-y-6 text-sm font-light text-white/85">
