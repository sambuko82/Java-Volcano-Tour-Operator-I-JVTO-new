    ...
    <main className="min-h-screen bg-page">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl">
          ...
          >
            Operational <span className="text-jvto-orange italic">Excellence</span>
          </motion.div>
          <motion.h1 
          ...
          >
            Why Travel with <br /> <span className="italic font-light text-jvto-orange">JVTO?</span>
          </motion.h1>
      ...
      <section id="trust-stack" className="py-48">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-32">
            <h2 className="text-7xl md:text-[10rem] font-serif text-text-primary mb-12 leading-[0.85] tracking-tight">The JVTO <br /> <span className="italic font-light text-jvto-orange">Trust Stack</span></h2>
            <p className="text-2xl text-text-secondary max-w-3xl mx-auto font-light leading-relaxed tracking-wide">Our trust stack is simple to understand and easy to verify. It starts with legal identity and extends through operational safety.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="bg-card p-16 rounded-[80px] border border-border-base shadow-2xl shadow-accent/5 hover:shadow-accent/10 transition-all group">
                <item.icon className="text-jvto-orange mb-10 group-hover:scale-110 transition-transform" size={48} />
                <h3 className="text-4xl font-serif text-text-primary mb-8 leading-tight">{item.title}</h3>
                <p className="text-text-secondary font-light leading-relaxed text-lg">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-48 bg-card rounded-[80px] shadow-2xl shadow-accent/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-32 gap-12 border-b border-border-base pb-16">
            <div>
              <div className="flex items-center gap-4 text-jvto-orange mb-8">
                <ShieldCheck size={32} />
                <span className="font-bold tracking-[0.4em] uppercase text-[10px]">Audit Our Credentials</span>
              </div>
              <h2 className="text-7xl md:text-[10rem] font-serif text-text-primary leading-[0.85] tracking-tight">Verification <br /> <span className="italic font-light text-jvto-orange">& Proof</span></h2>
            </div>
            <Link href="/verify-jvto" className="inline-flex items-center gap-6 text-accent font-bold text-xs uppercase tracking-[0.3em] group border-b border-accent/20 pb-3 hover:border-accent transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              ...
              <div key={i} className="bg-page p-16 rounded-[80px] border border-border-base group">
                <item.icon className="text-jvto-orange mb-10 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-3xl font-serif text-text-primary mb-8 leading-tight">{item.title}</h3>
                <p className="text-text-secondary font-light leading-relaxed text-lg mb-12">{item.desc}</p>
                <Link href={item.link} className="inline-flex items-center gap-4 text-accent font-bold text-[10px] uppercase tracking-[0.2em] group/link">
      ...
      <section id="duty-first" className="py-48 bg-accent text-white rounded-[80px] -mt-24 relative z-10 shadow-2xl shadow-accent/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            <div>
              <h2 className="text-7xl md:text-[10rem] font-serif mb-16 leading-[0.85] tracking-tight">Duty First, <br /> <span className="italic font-light text-jvto-orange">Business Second</span></h2>
              ...
              <div className="flex items-center gap-8 p-10 bg-white/5 backdrop-blur-md border border-white/10 rounded-[48px]">
                <div className="w-20 h-20 rounded-full overflow-hidden shrink-0 border-2 border-jvto-orange">
                ...
                <div>
                  <p className="text-jvto-orange font-bold uppercase tracking-[0.3em] text-[10px] mb-2">Founder Spotlight</p>
      ...
      <section className="py-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            <h2 className="text-6xl md:text-8xl font-serif text-text-primary mb-8 leading-[0.9] tracking-tight">The People <br /> <span className="italic font-light text-jvto-orange">Behind the Proof</span></h2>
            <p className="text-2xl text-text-secondary max-w-3xl mx-auto font-light leading-relaxed tracking-wide">The JVTO experience is delivered by real local people whose names, roles, and strengths matter to the quality of the trip.</p>
          </div>
          <CrewGrid />
        </div>
      </section>
      ...
      <section className="py-40 bg-card rounded-[80px] shadow-2xl shadow-accent/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            <h2 className="text-6xl md:text-8xl font-serif text-text-primary mb-8 leading-[0.9] tracking-tight">How to Verify Us <br /> <span className="italic font-light text-jvto-orange">in 60 Seconds</span></h2>
            <p className="text-2xl text-text-secondary max-w-3xl mx-auto font-light leading-relaxed tracking-wide">If you are careful about where you send your money and who you trust, you should verify the operator before you book.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            {[
              ...
              <div key={i} className="text-center p-12 bg-page rounded-[64px] border border-border-base group">
                <div className="w-16 h-16 bg-card rounded-full flex items-center justify-center mx-auto mb-8 text-accent shadow-xl shadow-accent/5 font-serif text-2xl group-hover:scale-110 transition-transform">{item.step}</div>
                <h3 className="text-2xl font-serif text-text-primary mb-4 leading-tight">{item.title}</h3>
                <p className="text-text-secondary font-light leading-relaxed text-lg mb-8">{item.desc}</p>
                <Link href={item.link} className="text-accent font-bold text-xs uppercase tracking-widest border-b border-accent/20 pb-1 hover:border-accent transition-all">{item.label}</Link>
              </div>
            ))}
          </div>
          
          <div className="mt-24 text-center">
            <Link href="/verify-jvto" className="inline-flex items-center gap-4 bg-accent text-white px-16 py-6 rounded-full text-xs font-bold uppercase tracking-[0.2em] hover:brightness-110 transition-all shadow-xl shadow-accent/20 group">
      ...
      <section className="py-40 text-center">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-6xl md:text-9xl font-serif text-text-primary mb-12 leading-[0.9] tracking-tight">Don’t Guess. <br /> <span className="italic font-light text-jvto-orange">Verify.</span></h2>
          <p className="text-2xl text-text-secondary leading-relaxed font-light tracking-wide">
      ...
      <section className="py-40 bg-accent text-white rounded-t-[80px] shadow-2xl shadow-accent/20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-6xl md:text-9xl font-serif mb-16 leading-[0.9] tracking-tight">Ready for Operational <br /> <span className="italic font-light text-jvto-orange">Certainty?</span></h2>
          <div className="flex flex-wrap justify-center gap-8">
            <Link href="/tours" className="bg-jvto-orange text-white px-16 py-6 rounded-full text-xs font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-accent transition-all flex items-center gap-4 group shadow-xl shadow-accent/20">
