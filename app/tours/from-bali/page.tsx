  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-brand-olive text-white pt-40 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-stone-300">Direct private transfers and volcano expeditions from Bali to the heart of East Java&apos;s volcanic landscape.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-4">Why Start in Bali?</h2>
            <p className="text-stone-600 max-w-2xl mx-auto">Bali is a popular starting point for those looking to experience Ijen Crater first.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-10 rounded-3xl border border-stone-200 shadow-sm">
              ...
              <h3 className="text-2xl font-display font-bold mb-4">Direct Ijen Access</h3>
              <p className="text-stone-600 text-sm">Starting in Bali provides the most direct route to Ijen Crater, making it ideal for guests who want to prioritize the blue fire experience.</p>
            </div>
            <div className="bg-white p-10 rounded-3xl border border-stone-200 shadow-sm">
              <Users className="text-orange-500 mb-6" size={40} />
              <h3 className="text-2xl font-display font-bold mb-4">Seamless Private Transfers</h3>
              <p className="text-stone-600 text-sm">We provide door-to-door private transfers from your Bali hotel to your East Java accommodation, including the ferry crossing.</p>
            </div>
            <div className="bg-white p-10 rounded-3xl border border-stone-200 shadow-sm">
              <Clock className="text-orange-500 mb-6" size={40} />
              <h3 className="text-2xl font-display font-bold mb-4">Best for Ijen-First Routes</h3>
              <p className="text-stone-600 text-sm">Most of our Bali-origin tours are optimized to visit Ijen first, followed by Bromo and a drop-off in Surabaya or a return to Bali.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-4">Featured Bali Routes</h2>
            <p className="text-stone-600 max-w-2xl mx-auto">Our most popular private tours starting from the Bali hub.</p>
          </div>
      ...
      <section className="py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-4">Logistics: Bali to East Java</h2>
            <p className="text-stone-600 max-w-2xl mx-auto">What to expect during your private transfer from Bali.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <Ship className="text-orange-500 mx-auto mb-6" size={40} />
              <h3 className="text-xl font-bold mb-4">Ferry & Transfer Times</h3>
              <p className="text-stone-600 text-sm">Bali to Ijen: 4-6 hours. This includes the 45-minute ferry crossing from Gilimanuk to Ketapang. We handle all ferry logistics.</p>
            </div>
            <div>
              <MapPin className="text-orange-500 mx-auto mb-6" size={40} />
              <h3 className="text-xl font-bold mb-4">Pick-up & Drop-off Points</h3>
              <p className="text-stone-600 text-sm">We offer full flexibility for pick-up at any hotel in Bali and drop-off in East Java or a return to Bali.</p>
            </div>
            <div>
              <ShieldCheck className="text-orange-500 mx-auto mb-6" size={40} />
              <h3 className="text-xl font-bold mb-4">Operational Certainty</h3>
              <p className="text-stone-600 text-sm">Our drivers are experienced with the Bali-to-Java route, ensuring a smooth and safe transition between islands.</p>
            </div>
          </div>
        </div>
      </section>
